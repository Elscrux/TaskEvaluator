...
public sealed record CodeGenerationResult(Guid TaskId, bool Success, Code Code, string GeneratedPart, string Generator, TimeSpan GenerationTime, int RetryCount = 0) {
