...
//
// public sealed class CSharpMethodRuntimeFactory(
//     ILogger<CSharpMethodRuntimeFactory> logger,
//     RuntimeEngine runtimeEngine)
//     : IRuntimeFactory {
//     public async Task<IRuntime> Create(Code code, CancellationToken token = default) {
//         logger.LogTrace("Parsing the code into the SyntaxTree");
...
//
//         logger.LogTrace("Adding the following references:\n{References}", string.Join("\n\t", refPaths));
//
//         logger.LogTrace("Compiling ...");
...
//         }
//
//         logger.LogTrace("Compilation successful! Now instantiating and executing the code ...");
...
//         }
//
//         return new DockerRuntime(code, instance, methodInfo);
//     }
// }
